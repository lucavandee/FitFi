/*
  # Enhanced Dashboard and Referral System

  1. New Tables
    - `profiles` - User profiles with referral tracking
    - `referrals` - Referral tracking system  
    - `user_stats` - Dashboard statistics

  2. Security
    - Enable RLS on all tables
    - Add policies for user data access
    - Public leaderboard access for profiles

  3. Functions
    - get_referral_stats() - Get user referral statistics
    - get_referral_leaderboard() - Get top referrers
    - create_user_referral_code() - Generate unique codes
...
DROP POLICY IF EXISTS "profiles_read_leaderboard" ON profiles;
