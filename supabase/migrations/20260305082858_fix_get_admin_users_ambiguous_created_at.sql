/*
  # Fix get_admin_users - ambiguous created_at column

  The function fails with "column reference created_at is ambiguous" because
  customer_subscriptions.created_at conflicts with profiles.created_at in the
  LATERAL subquery ORDER BY clause. Fully qualify the column reference.
*/
