...
const handler = async (event) => {
    ...
    try {
        const user = (_a = event.queryStringParameters) === null || _a === void 0 ? void 0 : _a.user;
        const count = ((_b = event.queryStringParameters) === null || _b === void 0 ? void 0 : _b.count) ? parseInt(event.queryStringParameters.count, 10) : 3;
        const archetype = (_c = event.queryStringParameters) === null || _c === void 0 ? void 0 : _c.archetype;
        const gender = (_d = event.queryStringParameters) === null || _d === void 0 ? void 0 : _d.gender;
        const season = (_e = event.queryStringParameters) === null || _e === void 0 ? void 0 : _e.season;
        let userObj = null;
        if (user) {
            try {
