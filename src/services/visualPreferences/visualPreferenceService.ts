...
export class VisualPreferenceService {
  ...
  static async getAllMoodPhotos(
    ...
    // Client-side safety filter: always strip photos that don't match the requested gender.
    // This is the last line of defence — showing 0 photos is better than wrong-gender photos.
