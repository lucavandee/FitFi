  ...
  if (APP_ENV.USE_SUPABASE) {
    ...
    if (sb) {
      try {
        ...
        console.warn(
          "[SavedOutfits] isSaved check failed, using local:",
          error,
        );
      }
    }
  ...
  if (APP_ENV.USE_SUPABASE) {
    ...
    if (sb) {
      try {
        ...
        console.warn(
          "[SavedOutfits] Supabase save failed, using local:",
          error,
        );
      }
    }
  ...
  if (APP_ENV.USE_SUPABASE) {
    ...
    if (sb) {
      try {
        ...
        console.warn(
          "[SavedOutfits] Supabase remove failed, using local:",
          error,
        );
      }
    }
...
export async function toggleSave(
  ...
  if (saved) {
    ...
    await saveOutfit(
      outfitId,
      outfitJson || { id: outfitId, title: "Saved Outfit" },
    );
    return true;
  }
}
  ...
  if (APP_ENV.USE_SUPABASE) {
    ...
    if (sb) {
      try {
        ...
        console.warn(
          "[SavedOutfits] Supabase clear failed, using local:",
          error,
        );
      }
    }
