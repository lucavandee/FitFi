 ...
 */
export function lt_getUserRole(tribeId: string, userId: string): 'member' | 'moderator' | 'owner' | null {
  try {
    const members = lt_getMembers(tribeId);
 ...
 */
export function lt_togglePostLike(postId: string, tribeId: string, userId: string): { liked: boolean; newCount: number } {
  try {
 ...
 * Get user's role in tribe
 */
export function lt_getUserRole(tribeId: string, userId: string): TribeRole | null {
  try {
    const members = lt_getMembers(tribeId);
