...
export const isBolt =
  typeof window !== "undefined" && /(^|\.)bolt\.new$/.test(Env.host);
export const isPreview = isBolt || Env.mode !== "production";
export const disableMigrations = Env.flag(
  "VITE_DISABLE_MIGRATIONS",
  isPreview ? "true" : "true",
);
export const muteThirdParty = Env.flag(
  "VITE_DISABLE_THIRD_PARTY",
  isPreview ? "true" : "true",
);
