...
export const FOUNDERS_TIERS: FounderTier[] = [
  {
    ...
    icon: 'Gift',
    perks: [
      { id: 'community', label: 'Early community access', unlockedAt: 0, icon: 'Users' },
      { id: 'profile-badge', label: 'Founders badge in profiel', unlockedAt: 0, icon: 'Ticket' },
    ],
  },
  {
    id: 'alpha',
    ...
    perks: [
      ...
      { id: 'feature-early', label: 'Vroege toegang: Nova Style Preview', unlockedAt: 4, icon: 'Wand2' },
      { id: 'leaderboard', label: 'Toegang tot referral leaderboard', unlockedAt: 5, icon: 'Trophy' },
    ],
  },
  {
    id: 'elite',
    ...
    icon: 'Star',
    perks: [
      { id: 'priority', label: 'Priority support', unlockedAt: 10, icon: 'Shield' },
      { id: 'group-style', label: 'AI styling sessie (groep)', unlockedAt: 12, icon: 'Headphones' },
      { id: 'frame', label: 'Limited edition profiel frame', unlockedAt: 14, icon: 'Sparkles' },
    ],
  },
  {
    id: 'legend',
    ...
    icon: 'Crown',
    perks: [
      { id: 'lifetime', label: 'Lifetime Premium', unlockedAt: 25, icon: 'Crown' },
      { id: 'one-to-one', label: '1-op-1 AI-stylist sessie', unlockedAt: 30, icon: 'Video' },
      { id: 'feature-vote', label: 'Feature voting rights', unlockedAt: 35, icon: 'Star' },
      { id: 'exclusive-drops', label: 'Exclusieve drops', unlockedAt: 40, icon: 'Gift' },
    ],
  },
];
...
export function allPerksSorted() {
  return FOUNDERS_TIERS
    .flatMap(t => t.perks.map(p => ({ ...p, tierId: t.id, tierName: t.name, tierThreshold: t.threshold })))
