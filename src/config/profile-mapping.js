...
export const DUTCH_ARCHETYPES = {
  klassiek: {
    ...
    description:
      "Tijdloze elegantie en verfijnde stukken die nooit uit de mode gaan",
  ...
  casual_chic: {
    ...
    description:
      "Moeiteloos elegant met een relaxte twist - perfect voor de moderne lifestyle",
  ...
  urban: {
    ...
    displayName: "Urban",
    description:
      "Stoere stadslook met functionele details - gemaakt voor het moderne stadsleven",
  ...
  streetstyle: {
    ...
    description:
      "Authentieke streetwear met attitude - voor de echte trendsetter",
  ...
  retro: {
    ...
    displayName: "Retro",
    description:
      "Vintage vibes met moderne twist - nostalgie die nooit verveelt",
