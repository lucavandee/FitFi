...
export default function ProductRail({ items, onClickItem }: Props) {
  ...
  return (
    <section aria-label="Aanbevolen items" className="mt-3">
      <h4 className="mb-2 text-sm font-medium text-[#1A1A1A]">Aanbevolen items</h4>
          ...
          <li key={p.id} className="group">
            <a
              ...
              className={cn(
                ...
                "transition hover:shadow-md focus:outline-none focus:ring-2 focus:ring-[#B55E45]/30"
              )}
            >
              ...
              <div className="p-3">
                <div className="line-clamp-2 text-sm text-[#1A1A1A]">{p.title}</div>
