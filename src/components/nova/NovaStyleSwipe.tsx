...
export default function NovaStyleSwipe({
  items = [],
  className = "",
}: {
  items: OutfitItem[];
      ...
      <section aria-label="AI Style Preview" className={className}>
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">
            Nova bereidt je persoonlijke outfits voor.
          </p>
        </div>
      </section>
    );
      ...
      >
        {items.map((it, index) => (
          ...
          >
            ...
            <div className="p-4">
              <div className="mb-3">
                <h3 className="font-medium text-[#0D1B2A] line-clamp-1 mb-1">
                  {it.title}
                </h3>
                {it.subtitle && (
