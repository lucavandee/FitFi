    ...
    return (
      <div className={`text-center py-12 ${className}`}>
        <div className="max-w-md mx-auto">
          <Heart className="w-16 h-16 mx-auto mb-4 text-[#A85740]" />
    ...
    <div className={`relative ${className}`}>
      ...
      <div className="hidden md:flex items-center justify-center gap-4 mt-6">
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 min-h-[48px] bg-[#FFFFFF] border border-[#E5E5E5] text-[#1A1A1A] rounded-xl font-medium text-base hover:border-[#A85740] transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 min-h-[48px] bg-[#FFFFFF] border border-[#E5E5E5] text-[#1A1A1A] rounded-xl font-medium text-base hover:border-[#A85740] transition-colors duration-200"
          aria-label="Sla over"
        >
          Sla over
        </button>
        ...
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 min-h-[48px] bg-[#9A503B] text-white rounded-xl font-semibold text-base hover:bg-[#A85740] transition-colors duration-200"
      ...
      <div className="md:hidden flex items-center justify-center gap-3 mt-6 px-4">
        <button
          onClick={() => handleSwipeLeft()}
          className="flex-1 flex items-center justify-center gap-2 px-4 py-3 min-h-[52px] bg-[#FFFFFF] border border-[#E5E5E5] text-[#1A1A1A] rounded-xl font-medium text-base hover:border-[#A85740] transition-colors duration-200"
          aria-label="Sla over"
        >
          Sla over
        </button>
        ...
        <button
          onClick={() => handleSwipeRight()}
          className="flex-1 flex items-center justify-center gap-2 px-4 py-3 min-h-[52px] bg-[#9A503B] text-white rounded-xl font-semibold shadow-lg active:scale-[0.98]"
          aria-label="Bewaar outfit"
        >
          <Heart className="w-5 h-5" />
          Bewaar
