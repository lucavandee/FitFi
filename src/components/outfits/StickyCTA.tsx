      ...
      <div className="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between gap-2">
        ...
        <div className="flex gap-2">
          {secondaryTo && secondaryLabel ? (
            <NavLink to={secondaryTo} className="bg-white border border-[#E5E5E5] hover:border-[#A85740] text-[#1A1A1A] font-medium text-base py-3 px-6 rounded-xl">
              {secondaryLabel}
            </NavLink>
          ) : null}
          <NavLink to={primaryTo} className="bg-[#A85740] hover:bg-[#9A503B] text-white font-semibold text-base py-3 px-6 rounded-xl">
            {primaryLabel}
          </NavLink>
        </div>
      </div>
