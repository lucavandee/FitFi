...
export default function OutfitCard({
  ...
  const handleSave = () => {
    ...
    try {
      ...
      toast.success(
        newSavedState ? "Outfit bewaard!" : "Outfit verwijderd uit favorieten",
      );
    }
    ...
    >
      ...
      <div className="space-y-3">
        <div>
          ...
          <p id={descId} className="mt-1 text-sm text-gray-600 leading-relaxed">
            {outfit.description}
          </p>
        </div>
        ...
        <div className="mt-3 grid grid-cols-2 gap-2">
          <RequireAuth cta="Inloggen om te bewaren">
            ...
            >
              <Heart
                className={`w-3 h-3 inline mr-1 ${saveOutfit.isSuccess || saved ? "fill-current" : ""} ${saveOutfit.isPending ? "animate-pulse" : ""}`}
              />
              {saveOutfit.isSuccess
                ? "Bewaard ✓"
          ...
          <RequireAuth cta="Inloggen voor meer looks">
            ...
            >
              <ThumbsUp
                className={`w-3 h-3 inline mr-1 ${isProcessing.like ? "animate-pulse" : ""}`}
              />
              Meer zoals dit
            </button>
          </RequireAuth>
          ...
          <RequireAuth cta="Inloggen voor feedback">
            ...
            >
              <ThumbsDown
                className={`w-3 h-3 inline mr-1 ${isProcessing.dislike ? "animate-pulse" : ""}`}
              />
              Niet mijn stijl
            </button>
          </RequireAuth>
          ...
          <RequireAuth cta="Inloggen voor uitleg">
            ...
            >
              <MessageCircle
                className={`w-3 h-3 inline mr-1 ${isProcessing.explain ? "animate-pulse" : ""}`}
              />
