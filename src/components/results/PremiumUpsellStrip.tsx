    ...
    <section className={`res-upsell ${className ?? ""}`} aria-labelledby="upsell-heading">
      <div className="res-upsell__copy">
        ...
        <div className="res-upsell__ctas">
          <button className="bg-[#B55E45] hover:bg-[#9A503B] text-white font-semibold text-base py-3 px-6 rounded-xl" onClick={handleClick} aria-label="Meer outfits zien met Premium">
            Meer outfits zien
          </button>
          <a className="bg-white border border-[#E5E5E5] hover:border-[#B55E45] text-[#1A1A1A] font-medium text-base py-3 px-6 rounded-xl" href="/prijzen">
            Bekijk pakketten
          </a>
        </div>
      </div>
