...
export function ColorSwatchWithLabel({
  ...
  const recommendationColor = recommendation === 'do' ? 'text-[#B55E45] bg-[#F4E8E3]' :
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      {/* Color Swatch */}
      <motion.button
        className={`${sizeClasses[size]} rounded-xl shadow-md relative overflow-hidden cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#B55E45] focus:ring-offset-2 transition-all`}
