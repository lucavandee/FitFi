  ...
  return (
    <div className="rounded-2xl border border-[#E5E5E5] bg-[#FAFAF8] p-5 shadow-sm">
      <div className="flex items-start gap-3 mb-3">
        <div className="w-8 h-8 rounded-full bg-[#B55E45] flex items-center justify-center">
      ...
      >
        ...
        <input
          ...
          className="rounded-xl border border-[#E5E5E5] bg-[#FFFFFF] px-4 py-3 outline-none focus:ring-2 focus:ring-[#B55E45]"
        />
        <Button
          type="submit"
          variant="primary"
