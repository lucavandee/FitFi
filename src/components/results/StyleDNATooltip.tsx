    ...
    return (
      <div className="relative">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 text-sm text-[#A85740] hover:text-[#9A503B] transition-colors font-medium"
              ...
              <div className="bg-gradient-to-br from-[#F5F0EB] to-[#F5F0EB] rounded-2xl p-6 border-2 border-[#F4E8E3] shadow-lg">
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-2">
                    <Sparkles className="w-5 h-5 text-[#A85740]" />
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-4">
                  {/* DO */}
                  <div>
                    <h5 className="font-semibold text-sm text-[#A85740] mb-2 flex items-center gap-1">
                    ...
                    <ul className="space-y-1.5">
                      {explanation.do.map((item, idx) => (
                        <li key={idx} className="text-sm text-[#4A4A4A] flex items-start gap-2">
                          <span className="text-[#A85740] mt-0.5">•</span>
                          <span>{item}</span>
                        </li>
                      ))}
                    </ul>
...
export function StyleDNAQuickTip({
  ...
  return (
    <div className="group relative inline-block">
      <HelpCircle className="w-4 h-4 text-gray-400 hover:text-[#A85740] transition-colors cursor-help" />
