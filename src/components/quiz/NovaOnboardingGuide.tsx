  ...
  if (isMinimized) {
    return (
      <motion.button
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
        className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-gradient-to-r from-[#B55E45] to-[#B55E45] shadow-lg flex items-center justify-center hover:scale-110 transition-transform"
        ...
        <div className="bg-[#FFFFFF] border border-[#E5E5E5] rounded-2xl shadow-lg p-4">
          ...
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-gradient-to-r from-[#B55E45] to-[#B55E45] flex items-center justify-center">
            ...
            <button
              ...
              className={`mt-3 w-full text-xs py-2 px-3 rounded-2xl border transition-colors ${
                showProactiveTrigger
                  ? 'border-[#B55E45] bg-[#B55E45]/10 text-[#B55E45] font-medium animate-pulse'
                  : 'border-[#E5E5E5] hover:border-[#B55E45] hover:bg-[#B55E45]/5 text-[#1A1A1A]/70 hover:text-[#1A1A1A]'
              }`}
            >
