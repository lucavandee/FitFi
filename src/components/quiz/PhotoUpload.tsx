  ...
  return (
    ...
    >
      ...
      <p className="mt-1 text-sm text-[var(--color-text)]/70">
        Upload een duidelijke foto (goed licht, geen filter). We verwerken de
        foto alleen lokaal in je browser.
      </p>
      ...
      {value ? (
        <div className="mt-4">
          <img
            src={value}
            alt="Voorbeeld van geüploade foto"
            className="max-h-56 rounded-[var(--radius-xl)] border border-[var(--color-border)]"
          />
        </div>
      ) : null}
    </div>
