  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="mt-6 p-4 bg-gradient-to-r from-[#A85740]/5 to-[#A85740]/5 border border-[#A85740]/20 rounded-2xl"
      >
        <div className="flex items-start gap-3">
          <motion.div
            ...
            className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-[#A85740] to-[#A85740] flex items-center justify-center"
          >
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              ...
              <Sparkles className="w-3 h-3 text-[#A85740]" />
            </div>
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
