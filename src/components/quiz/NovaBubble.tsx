...
export function NovaBubble({ message, onDismiss, autoHideDuration = 5000 }: NovaBubbleProps) {
  return (
    <AnimatePresence>
      ...
      >
        <motion.div
          className="bg-[#FFFFFF] border border-[#E5E5E5] rounded-2xl shadow-2xl p-4 pr-12"
        ...
        <motion.div
          ...
          className="absolute -bottom-2 left-8 w-4 h-4 bg-[#FFFFFF] border-l border-b border-[#E5E5E5] transform rotate-45"
        />
      </motion.div>
    </AnimatePresence>
  );
