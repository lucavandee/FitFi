...
`.trim();
  ...
  return (
    <AnimatePresence>
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-[#E5E5E5] bg-gradient-to-r from-[#A85740]/5 to-[#A85740]/5">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#A85740] to-[#A85740] flex items-center justify-center">
          ...
          {isLoading && (
            <div className="flex justify-start">
              <div className="bg-[#FAFAF8] rounded-2xl px-4 py-2">
                <Loader2 className="w-4 h-4 animate-spin text-[#A85740]" />
              </div>
            </div>
          )}
        ...
        <div className="p-4 border-t border-[#E5E5E5]">
          <div className="flex items-end gap-2">
            <input
              ...
              disabled={isLoading}
              className="flex-1 px-4 py-2 bg-[#FAFAF8] border border-[#E5E5E5] rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-[#A85740] disabled:opacity-50"
            />
            <button
              onClick={sendMessage}
              disabled={!input.trim() || isLoading}
              className="p-2 bg-[#A85740] text-white rounded-2xl hover:bg-[#A85740]/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
