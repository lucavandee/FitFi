    ...
    <div className={`fixed inset-0 z-50 flex items-center justify-center p-4 ${className}`}>
      ...
      <div className={`relative bg-white rounded-2xl shadow-2xl max-w-md w-full transform transition-all duration-300 ${
        ...
        <div className="p-8">
          ...
          {/* Preview */}
          <div className="bg-gradient-to-br from-[#B55E45]/10 to-purple-50 rounded-2xl p-4 mb-6">
            <div className="text-sm text-gray-700">
              ...
              <br />
              <span className="text-[#B55E45]">#FitFiStyle #AIStyleAnalysis</span>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 pt-4">
            <Button
              ...
              iconPosition="left"
              className="text-[#B55E45] hover:bg-[#B55E45]/10"
            >
