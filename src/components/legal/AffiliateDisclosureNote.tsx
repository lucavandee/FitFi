  ...
  return (
    <div className={`mt-4 rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-700 ${className}`}>
      <div className="flex items-start gap-3">
        <span className="mt-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-[var(--ff-color-primary-50)] text-[var(--color-text)]">
          <Info size={14} />
        </span>
        <p>
          ...
          Meer info in onze <a href="/disclosure" className="underline">Affiliate Disclosure</a>.
        </p>
      </div>
    </div>
  );
