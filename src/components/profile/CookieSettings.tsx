    ...
    <div className="space-y-1">
      ...
      <div className="space-y-px">
        ...
        <div className="flex items-center justify-between py-3">
          <div className="min-w-0 pr-4">
            <p className="text-sm font-medium text-[#6E6E6E]">Marketing cookies</p>
            <p className="text-xs text-[#6E6E6E] mt-0.5">Niet van toepassing</p>
          </div>
          <span className="text-xs font-semibold text-[#6E6E6E] flex-shrink-0">Niet gebruikt</span>
        </div>
