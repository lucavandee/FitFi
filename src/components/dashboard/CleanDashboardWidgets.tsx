    ...
    <BentoCard size="large" className="p-0 overflow-hidden">
      ...
      {featuredImage ? (
        ...
        <div className="p-6">
          ...
          <NavLink
            to="/results"
            className="w-full inline-flex items-center justify-center gap-1.5 px-6 py-3 bg-[var(--ff-color-primary-700)] text-white rounded-xl text-base font-semibold hover:bg-[var(--ff-color-primary-600)] transition-colors duration-200"
          >
            Bekijk alles
            <ArrowRight className="w-4 h-4" />
          </NavLink>
