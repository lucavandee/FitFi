...
const StatCard: React.FC<StatCardProps> = ({ icon, value, label, gradient, large }) => (
  <div className={`group relative overflow-hidden ${large ? 'p-8' : 'p-6'} bg-white/90 dark:bg-[#FFFFFF]/90 backdrop-blur-xl rounded-2xl border border-[#E5E5E5] shadow-xl hover:shadow-2xl transition-all duration-300 hover-lift`}>
