...
export function PremiumHeaderCard({
  ...
  const headerContent = (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#A85740] via-[#9A503B] to-[#A85740] shadow-2xl">
...
export function PremiumActionCard({
  ...
  const content = (
    <div className="flex items-center gap-4 p-4 rounded-xl bg-[#FAFAF8] border-2 border-[#E5E5E5] hover:border-[#A85740] transition-all group cursor-pointer">
      <div
  ...
  return (
    <button
      ...
      className={`flex items-center gap-2 px-6 py-3 rounded-xl font-semibold transition-all whitespace-nowrap ${
        isActive
          ? 'bg-gradient-to-r from-[#A85740] to-[#A85740] text-white shadow-lg'
          : 'bg-[#FFFFFF] text-[#1A1A1A] border-2 border-[#E5E5E5] hover:border-[#A85740]'
      }`}
    >
