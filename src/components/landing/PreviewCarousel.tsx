...
const PreviewCarousel: React.FC<PreviewCarouselProps> = ({
  ...
  const previews: PreviewItem[] = [
    ...
    },
    {
      ...
      image:
        "https://images.pexels.com/photos/1280064/pexels-photo-1280064.jpeg?auto=compress&cs=tinysrgb&w=600&h=800&dpr=2",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Krijg een voorproefje van de diepgaande inzichten die Nova voor jou
            heeft
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Dit is slechts een voorproefje. Jouw volledige AI Style Report bevat
            nog veel meer gepersonaliseerde inzichten en aanbevelingen.
          </p>
        </div>
      </div>
    </section>
