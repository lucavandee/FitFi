...
-        <h2 className="text-2xl font-bold text-[#0D1B2A]">Veelgestelde vragen</h2>
-        <div className="mt-6 divide-y divide-slate-200 rounded-2xl bg-white shadow-sm">
...
-              <div className="mt-3 text-sm text-slate-700">{it.a}</div>
