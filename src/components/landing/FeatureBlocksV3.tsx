        ...
        {features.map((feature, index) => (
          ...
          >
                ...
                <div className="absolute -bottom-8 -right-8 bg-white rounded-2xl shadow-2xl p-8 border-2 border-[#E5E5E5]">
                  <div className="flex gap-10">
                    {feature.stats.map((stat, idx) => (
                      <div key={idx}>
                        <div className="text-4xl font-bold text-[#A85740] mb-2">
                          {stat.value}
                        </div>
            ...
            <div className={feature.reversed ? 'lg:col-start-1 lg:row-start-1' : ''}>
              ...
              {/* Description */}
              <p className="text-2xl text-[#6E6E6E] leading-relaxed mb-10 font-light">
                {feature.description}
              </p>
              ...
              <div className="space-y-5">
                {feature.bullets.map((bullet, idx) => (
                  <div key={idx} className="flex items-center gap-4">
                    <div className="w-8 h-8 bg-[#F5F0EB] rounded-full flex items-center justify-center flex-shrink-0">
                      <svg className="w-5 h-5 text-[#A85740]" fill="currentColor" viewBox="0 0 20 20">
