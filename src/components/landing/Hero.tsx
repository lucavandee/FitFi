      ...
      <div className="container grid grid-cols-1 gap-8 lg:grid-cols-12">
        <div className="lg:col-span-7 flex flex-col justify-center">
          ...
          <div className="mt-7 flex flex-wrap items-center gap-3">
            <Link to="/registreren" className="btn btn-primary btn-lg" aria-label="Start gratis">
              Ja, geef mij mijn gratis AI Style Report
            </Link>
            <Link to="/hoe-het-werkt" className="btn btn-ghost btn-lg" aria-label="Hoe werkt het?">
              Hoe werkt het?
            </Link>
          </div>
        </div>
        ...
        <div className="lg:col-span-5">
          {/* Vervang deze div later door je SmartImage/hero visual; dit is compile-veilig. */}
