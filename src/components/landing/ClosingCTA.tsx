...
const ClosingCTA: React.FC<ClosingCTAProps> = ({
  ...
  return (
    <section
      className={`py-20 bg-gradient-to-br from-[#bfae9f] to-purple-600 ${className}`}
        ...
        <div className="text-center text-white">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              ...
              >
                Klaar om te ontdekken wat jouw stijl{" "}
                <span className="font-medium">over je zegt?</span>
              </h2>
              ...
              <p className="text-xl md:text-2xl text-white/90 leading-relaxed max-w-3xl mx-auto mb-8">
                ...
                ontvangen. Jij bent de volgende die zijn stijl en zelfvertrouwen
                transformeert.
              </p>
            </div>
            ...
            <div className="mb-12">
              <Button
                ...
                aria-label="Start je gratis AI Style Report nu"
              >
