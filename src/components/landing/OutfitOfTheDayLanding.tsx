...
interface OutfitOfTheDayLandingProps {
  className?: string;
}

const OutfitOfTheDayLanding: React.FC<OutfitOfTheDayLandingProps> = ({ className = '' }) => {
            ...
            <div key={item.id} className="w-full flex-shrink-0 relative">
              <div className="aspect-[4/5] relative">
                <ImageWithFallback
                  ...
                  componentName="OutfitOfTheDayLanding"
                />
...
export default OutfitOfTheDayLanding;