        ...
        <div>
          ...
          <div className="mt-6 flex items-center gap-3">
            <Link to="/onboarding" className="btn btn-primary"
              onClick={()=>track("nova:cta",{where:"hero",action:"onboarding"})}>Doe de stijlscan</Link>
            <Link to="/results" className="btn btn-ghost"
              onClick={()=>track("nova:cta",{where:"hero",action:"demo"})}>Bekijk demo</Link>
          </div>
          <p className="ff-subtle mt-4">Geen druk. Geen onzin. Wel een heldere uitleg per outfit.</p>
        </div>
        <div className="relative">
          <div className="aspect-[4/3] w-full rounded-2xl bg-gradient-to-br from-[rgba(137,207,240,.25)] via-white to-[rgba(13,27,42,.06)] shadow-[0_10px_30px_rgba(13,27,42,.08)] grid place-items-center">
