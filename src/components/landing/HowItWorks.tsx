  ...
  const steps: Step[] = [
    {
      ...
      description:
        "Beantwoord enkele vragen over jouw stijlvoorkeuren en persoonlijkheid. Duurt slechts 2 minuten.",
    ...
    },
    {
      ...
      description:
        "Onze AI analyseert jouw antwoorden psychologisch en stijltechnisch voor diepgaande inzichten.",
      icon: <Brain size={32} />,
    ...
    },
    {
      ...
      description:
        "Direct jouw stijlrapport met inzichten, outfit-tips en persoonlijke aanbevelingen.",
          ...
          {steps.map((step, index) => (
            <div key={step.id} className="relative">
              ...
              <div className="relative bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow text-center">
                ...
                {/* Icon */}
                <div
                  className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-6 ${step.color}`}
                >
                  {step.icon}
                </div>
