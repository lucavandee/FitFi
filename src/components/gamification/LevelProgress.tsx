      ...
      <div className={`bg-white rounded-2xl p-4 ${className}`}>
        ...
        {nextLevelInfo && (
          <div className="w-full bg-gray-200 rounded-full h-2">
            <div 
              className="h-2 rounded-full bg-gradient-to-r from-[#A85740] to-blue-500 transition-all duration-1000 ease-out"
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            <div className="w-full bg-gray-200 rounded-full h-3">
              <div 
                className="h-3 rounded-full bg-gradient-to-r from-[#A85740] to-blue-500"
                style={{ 
      ...
      {showPerks && currentPerks.length > 0 && (
        <div className="mb-6">
          <h4 className="font-medium text-gray-900 mb-3 flex items-center">
            <Gift className="w-4 h-4 mr-2 text-[#A85740]" />
            Jouw huidige voordelen:
          </h4>
          <div className="space-y-2">
            {currentPerks.map((perk, index) => (
              <div key={index} className="flex items-center space-x-2 text-sm">
                <div className="w-2 h-2 bg-[#A85740] rounded-full"></div>
