          ...
          {[
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center space-x-2 py-3 px-4 rounded-xl transition-all duration-200 ${
                activeView === tab.id
                  ? 'bg-[#B55E45] text-white shadow-sm'
        ...
        {activeView === 'overview' && (
          <div className="space-y-6">
            ...
            {earnedBadges.length > 0 && (
              <div className="bg-white rounded-2xl shadow-sm p-6">
                <div className="flex items-center space-x-2 mb-4">
                  <Gift className="w-5 h-5 text-[#B55E45]" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-r from-[#B55E45]/10 to-blue-50 rounded-2xl p-6">
                <h4 className="font-medium text-gray-900 mb-4">Deze Week</h4>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span className="text-gray-600">Punten verdiend:</span>
                    <span className="font-bold text-[#B55E45]">{weeklyPoints.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between">
