        ...
        {[
          ...
          <button
            ...
            className={`flex-1 flex items-center justify-center space-x-2 py-2 px-3 rounded-md transition-all duration-200 ${
              filter === tab.id
                ? 'bg-white text-[#B55E45] shadow-sm'
          ...
          >
            ...
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="text-right">
                <div className="text-lg font-bold text-[#B55E45]">+{challenge.points}</div>
            ...
            {challenge.progress !== undefined && challenge.maxProgress && (
              <div className="mb-4">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div 
                    className="bg-[#B55E45] h-2 rounded-full transition-all duration-300"
            ...
            <Button
              ...
              className={challenge.completed 
                ...
                : 'bg-[#B55E45] hover:bg-[#B55E45]/90 text-[#1A1A1A]'
              }
