          ...
          <div className="text-center lg:text-left space-y-8">
            <div className="space-y-6">
              <h1 id="hero-heading" className="text-4xl md:text-5xl lg:text-6xl font-light text-gray-900 leading-tight">
                Ontdek jouw ideale stijl{' '}
                <span className="font-medium text-[#bfae9f]">met Nova</span>
              </h1>
              
              <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-2xl">
                Jouw persoonlijke AI-stylist die perfect passende outfits voor je creëert, afgestemd op jouw persoonlijkheid.
              </p>
            </div>
