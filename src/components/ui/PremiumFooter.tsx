        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Link to="/hoe-het-werkt" className="bg-white border border-[#E5E5E5] hover:border-[#A85740] text-[#1A1A1A] font-medium text-base py-3 px-6 rounded-xl">Meer info</Link>
              <Link to="/prijzen" className="bg-[#A85740] hover:bg-[#9A503B] text-white font-semibold text-base py-3 px-6 rounded-xl">Start gratis</Link>
            </div>
          </div>
        </div>
