  ...
  return (
    <div className={`bg-white rounded-2xl shadow-sm p-6 ${className}`}>
      ...
      <div className="mb-6">
            ...
            <ul className="space-y-2">
              {challenge.rules.map((rule, i) => (
                <li key={i} className="flex items-start space-x-2 text-sm text-gray-600">
                  <div className="w-1.5 h-1.5 bg-[#C2654A] rounded-full mt-2 flex-shrink-0"></div>
                  <span>{rule}</span>
                </li>
              ))}
            </ul>
        ...
        {/* Rewards */}
        <div className="flex items-center justify-between mb-6 p-4 bg-[#C2654A]/10 rounded-2xl">
          <div className="flex items-center space-x-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-[#C2654A]">+{challenge.rewardPoints || 0}</div>
          ...
          <Trophy className="w-8 h-8 text-[#C2654A]" />
        </div>
      </div>
      ...
      <div className="border-t border-gray-200 pt-6">
        ...
        <form onSubmit={handle} className="space-y-4">
          ...
          <div>
            ...
            <textarea 
              className="w-full border border-gray-200 rounded-2xl p-4 focus:ring-2 focus:ring-[#C2654A] focus:border-[#C2654A] resize-none transition-colors" 
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className="text-[#C2654A] hover:text-[#C2654A]/80 text-sm flex items-center space-x-1"
              >
                <Image size={14} />
            ...
            {showImageInput && (
              <div className="space-y-2">
                <input 
                  className="w-full border border-gray-200 rounded-2xl p-3 focus:ring-2 focus:ring-[#C2654A] focus:border-[#C2654A] transition-colors" 
