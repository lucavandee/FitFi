        ...
        >
          ...
          <div className="flex items-start justify-between mb-4">
            ...
            <div className="flex items-center space-x-2">
              {submission.score && (
                <span className="px-3 py-1 bg-[#B55E45]/10 text-[#B55E45] rounded-full text-sm font-medium">
          ...
          {submission.linkUrl && (
            <div className="mb-4">
              <a
                ...
                className="inline-flex items-center space-x-2 text-[#B55E45] hover:text-[#B55E45]/80 transition-colors"
              >
