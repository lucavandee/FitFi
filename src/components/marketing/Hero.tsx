    ...
    <section className="relative overflow-hidden">
      ...
      <Container className="pt-16 pb-10 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <p className="mt-4 text-[#6E6E6E] text-[16px] leading-7">
          ...
          <div className="mt-6 flex items-center gap-3 text-[13px] text-[#6E6E6E]">
        ...
        <div className="bg-white border border-[#E5E5E5] rounded-2xl p-6 p-3">
          ...
          <div className="px-3 pb-3 pt-2 text-sm text-[#6E6E6E]">
