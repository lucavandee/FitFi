...
export function mdNova(input: string) {
  ...
  s = s.replace(
    /(https?:\/\/[^\s)<>"']+)/g,
    '<a href="$1" target="_blank" rel="nofollow noopener noreferrer" class="text-[var(--ff-color-primary-500)] underline decoration-[var(--ff-color-primary-500)] underline-offset-2 hover:opacity-80">$1</a>'
  );
