...
const AboutHero: React.FC<Props> = ({ onStart, onExample }) => {
  return (
    <PageHeroStacked
      ...
      lead="We combineren computer vision met een menselijk oog voor stijl. Zo krijg jij advies : outfits die passen bij silhouet, materialen en kleurtemperatuur — privacy-first."
      chips={["", "Mens + AI", "NL ontwerp"]}
      imageId="hero-main"
