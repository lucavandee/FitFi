...
const LEFT_PANEL_STEPS = [
  { n: "1", label: "Doe de stijlquiz", sub: "10 min · geen mode-kennis nodig" },
  { n: "2", label: "Ontdek jouw stijltype", sub: "Kleurpalet · archetype · tips" },
  { n: "3", label: "Shop met vertrouwen", sub: "50+ outfits op maat" },
];
        ...
        >
          ...
          <div className="relative z-10 flex flex-col justify-between h-full p-8 xl:p-12">
            ...
            <div>
              ...
              >
                {comingFromResults ? "Sla je resultaten op" : "In 3 stappen naar"}<br />
                <span style={{ color: "var(--ff-color-primary-300)" }}>
                  {comingFromResults ? "en shop direct" : "jouw stijlprofiel"}
                </span>
              </h2>
              <ol className="space-y-4 mb-8">
                {LEFT_PANEL_STEPS.map(({ n, label, sub }) => (
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-xs text-white/70 font-medium ml-1">+2.400 gebruikers</span>
                </div>
