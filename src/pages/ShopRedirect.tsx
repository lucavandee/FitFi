    ...
    <main className="min-h-screen flex items-center justify-center bg-[#F6F6F6]">
      ...
      <div className="card p-6 max-w-md text-center">
        ...
        <p className="text-gray-600 mt-2">
          We openen een winkel met je zoekopdracht:
        </p>
        <p className="mt-2 font-medium break-words">"{q || "outfit"}"</p>
        <a
          href={target}
          className="btn-primary mt-6 inline-block rounded-xl px-4 py-2 bg-[#89CFF0] text-[#0D1B2A] hover:bg-[#89CFF0]/90"
        >
          Open nu
        </a>
        <div className="text-xs text-gray-500 mt-3">
          Werkt de redirect niet?{" "}
          <Link to="/" className="underline text-[#89CFF0]">
            Terug naar FitFi
          </Link>
        </div>
      </div>
