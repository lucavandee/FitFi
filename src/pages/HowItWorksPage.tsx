...
import { ArrowRight, MessageSquare, Brain, Sparkles, Target } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#F6F6F6]">
      <div className="max-w-7xl mx-auto py-12 px-4 md:px-8 lg:px-16">
            ...
            <div className="bg-white rounded-3xl p-8 max-w-4xl mx-auto shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  <div className="w-12 h-12 bg-[#89CFF0]/20 rounded-full flex items-center justify-center mx-auto mb-3">
                    <Brain className="w-6 h-6 text-[#89CFF0]" />
                  </div>
                  <p className="text-gray-700">Psychologische stijlmatch, niet alleen kleurtjes</p>
                </div>
                
                <div className="text-center">
                  <div className="w-12 h-12 bg-[#89CFF0]/20 rounded-full flex items-center justify-center mx-auto mb-3">
                    <Target className="w-6 h-6 text-[#89CFF0]" />
                  </div>
                  <p className="text-gray-700">Onafhankelijk: wij verdienen pas als jij blij bent</p>
                </div>
                
                <div className="text-center">
                  <div className="w-12 h-12 bg-[#89CFF0]/20 rounded-full flex items-center justify-center mx-auto mb-3">
                    <MessageSquare className="w-6 h-6 text-[#89CFF0]" />
                  </div>
                  <p className="text-gray-700">Nederlandse klantenservice, vandaag nog antwoord</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-sm text-center relative">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Ontvang gepersonaliseerde outfit-suggesties die perfect bij je passen.
                </p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-sm text-center relative">
                ...
                <div className="w-16 h-16 bg-[#89CFF0]/20 rounded-full flex items-center justify-center mx-auto mb-6">
                  <Target className="w-8 h-8 text-[#89CFF0]" />
                </div>
        ...
        {/* Benefits Section */}
        <ErrorBoundary>
          <section className="bg-white rounded-3xl p-8 md:p-12 shadow-sm mb-16">
            <h2 className="text-3xl font-light text-[#0D1B2A] text-center mb-12">
              Waarom FitFi?
            </h2>
