  ...
  const steps = [
    {
      ...
      description: 'Beantwoord 5 vragen over je stijlvoorkeuren, lichaamsbouw en gelegenheden. Duurt 2 minuten.',
    ...
    },
    {
      ...
      description: 'Onze recommendation engine analyseert 10.000+ producten en creëert gepersonaliseerde outfits.',
      icon: <Brain size={32} />,
    ...
    },
    {
      ...
      description: 'Verdien punten, join tribes, deel outfits en koop direct bij retailers via affiliate links.',
      icon: <Users size={32} />,
        ...
        <ErrorBoundary>
          <section className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
              Van stijlquiz tot gepersonaliseerde outfits, community engagement en directe aankopen
            </p>
          </section>
        </ErrorBoundary>
          ...
          <section className="bg-white rounded-3xl shadow-sm p-8 md:p-12 mb-16">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Volledige platform met AI-technologie, community features en directe shopping integratie
              </p>
            </div>
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-medium text-[#0D1B2A] mb-2">Quiz Data Processing</h3>
                      <p className="text-gray-600">Supabase database opslag, real-time sync, progress persistence met localStorage.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-medium text-[#0D1B2A] mb-2">AI Matching Algorithm</h3>
                      <p className="text-gray-600">TypeScript engine met archetype scoring, seizoenslogica en product filtering.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-medium text-[#0D1B2A] mb-2">Real-time Features</h3>
                      <p className="text-gray-600">Live gamification updates, community posts, affiliate tracking en analytics.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="aspect-square bg-gradient-to-br from-[#89CFF0]/20 to-blue-50 rounded-3xl flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-medium text-[#0D1B2A] mb-2">Live Platform</h3>
        ...
        <ErrorBoundary>
          <section className="bg-gradient-to-r from-[#89CFF0]/10 to-blue-50 rounded-3xl p-8 md:p-12 mb-16">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Actuele data van het FitFi platform</p>
            </div>
            
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-[#89CFF0] mb-2">10.000+</div>
                <div className="text-sm text-gray-600">Gegenereerde rapporten</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">Gebruikersbeoordeling</div>
              </div>
            </div>
          </section>
        </ErrorBoundary>
          ...
          <section className="bg-gradient-to-r from-[#89CFF0] to-blue-500 rounded-3xl shadow-sm overflow-hidden">
            <div className="p-8 md:p-12 text-center">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
                Start vandaag nog met FitFi en ervaar zelf hoe ons complete platform jouw stijl transformeert.
              </p>
              <Button 
                as={Link}
                to="/registreren" 
