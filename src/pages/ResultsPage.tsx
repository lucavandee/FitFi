...
const ResultsPage: React.FC = () => {
  const isLoading = false; // fallback: altijd iets tonen
            ...
            <div className="ff-container grid items-start gap-10 lg:grid-cols-12">
              ...
              <div className="lg:col-span-5">
                <div className="relative w-full ml-auto max-w-[680px]">
                  <div aria-hidden className="block w-full h-auto aspect-[4/3] rounded-[var(--radius-2xl)] shadow-[var(--shadow-soft)]"
                       style={{ background: "linear-gradient(135deg, var(--ff-color-primary-600), var(--ff-color-primary-900))" }} />
                  <div aria-hidden className="pointer-events-none absolute -bottom-3 left-1/2 h-3 w-[82%] -translate-x-1/2 rounded-[var(--radius-lg)] bg-[var(--color-surface)] border border-[var(--color-border)] shadow-[var(--shadow-soft)]" />
                </div>
              </div>
            </div>
          </section>
