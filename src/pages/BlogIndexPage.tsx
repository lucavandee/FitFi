  ...
  const blogPosts: BlogPost[] = [
    {
      ...
      excerpt:
        "Ontdek wat jouw stijlvoorkeuren vertellen over jouw persoonlijkheid en hoe je dit kunt gebruiken om je doelen te bereiken.",
      author: "Dr. Sarah van der Berg",
      date: "2024-12-15",
      readTime: "5 min",
      category: "Psychologie",
      imageUrl:
        "https://images.pexels.com/photos/5935748/pexels-photo-5935748.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=2",
    ...
    },
    {
      ...
      excerpt:
        "Mode-regels zijn er om gebroken te worden. Leer welke traditionele stijlregels je veilig kunt negeren voor een modernere look.",
      author: "Emma Styling",
      date: "2024-12-12",
      readTime: "7 min",
      category: "Trends",
      imageUrl:
        "https://images.pexels.com/photos/1043474/pexels-photo-1043474.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=2",
    ...
    },
    {
      ...
      excerpt:
        "Hoe je met 30 items een complete garderobe creëert die altijd werkt. Tips voor het bouwen van een duurzame, veelzijdige kledingkast.",
      author: "Lisa Minimalist",
      date: "2024-12-10",
      readTime: "6 min",
      category: "Lifestyle",
      imageUrl:
        "https://images.pexels.com/photos/2905238/pexels-photo-2905238.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=2",
        ...
        <ErrorBoundary>
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
              Ontdek de laatste trends, styling tips en inzichten over mode,
              persoonlijkheid en zelfexpressie.
            </p>
              ...
              {categories.map((category) => (
                <button
                  ...
                  className={`px-6 py-2 rounded-full transition-colors ${
                    ...
                    (selectedCategory === null && category === "Alle")
          ...
          <div className="bg-gradient-to-r from-[#89CFF0] to-blue-500 rounded-3xl shadow-sm overflow-hidden">
            <div className="p-8 md:p-12 text-center">
              ...
              <p className="text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
                Ontvang wekelijks de nieuwste styling tips, trends en
                persoonlijke groei-inzichten direct in je inbox.
              </p>
