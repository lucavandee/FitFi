          ...
          <section className="ff-section ff-pricing-hero pt-24 sm:pt-28">
            <div className="ff-container--home">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                {/* Free */}
                <div className="bg-[var(--color-surface)] rounded-2xl border border-[var(--color-border)] hover:shadow-lg transition-all duration-300">
                  ...
                  <div className="p-6">
                    ...
                    <NavLink
                      to="/hoe-het-werkt"
                      className="ff-btn ff-btn-ghost w-full mt-3"
                    >
                      Bekijk voorbeeld
                    </NavLink>
                  </div>
                ...
                {/* Premium */}
                <div className="relative bg-[var(--color-surface)] rounded-2xl border-2 border-[var(--ff-color-primary-500)] shadow-xl">
