        ...
        <ErrorBoundary>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
              Start gratis en upgrade wanneer je klaar bent. Alle abonnementen
              komen met 14 dagen geld-terug garantie.
            </p>
            ...
            {plans.map((plan) => (
              <div
                ...
                className={`flex flex-col rounded-3xl shadow-lg/10 ring-1 ring-gray-100 bg-white px-8 py-10 gap-6 grow min-w-[88%] scroll-snap-align-center relative ${
                  plan.highlight
                    ? "ring-2 ring-[#89CFF0]/20 shadow-lg scale-105"
                    : ""
                }`}
              >
                {plan.popular && (
                ...
                <div className="text-center">
                  ...
                  <div className="mb-4">
                    <span className="text-4xl font-light text-[#0D1B2A]">
                      {plan.price}
                    </span>
                ...
                <ul className="space-y-4">
                  {plan.features.map((feature, index) => (
                    <li key={index} className="flex items-start space-x-3">
                      <Check
                        className="text-[#89CFF0] flex-shrink-0 mt-0.5"
                        size={18}
                      />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Ja, je kunt je abonnement op elk moment opzeggen. Geen
                  verborgen kosten of lange contracten.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Niet tevreden binnen 14 dagen? Krijg je geld terug, geen
                  vragen gesteld.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  iDEAL, creditcard, PayPal en bankoverschrijving. Alle
                  betalingen zijn beveiligd.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Ja, je kunt op elk moment upgraden. Je betaalt alleen het
                  verschil voor de resterende periode.
                </p>
              </div>
            </div>
          </section>
          ...
          <div className="bg-gradient-to-r from-[#89CFF0] to-blue-500 rounded-3xl shadow-sm overflow-hidden">
            <div className="p-8 md:p-12 text-center">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
                Begin vandaag nog gratis en ontdek hoe FitFi jouw stijl en
                zelfvertrouwen kan verbeteren.
              </p>
              <Button
                as={Link}
                to="/registreren"
