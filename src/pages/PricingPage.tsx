                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  {premiumProduct && (
                    <button
                      ...
                      disabled={isPending}
                      className="px-6 py-3 min-h-[48px] bg-[#A85740] text-white text-base font-semibold rounded-xl transition-colors disabled:opacity-50 whitespace-nowrap hover:bg-[#9A503B]"
                    >
                      Probeer opnieuw
                    </button>
                  )}
                      ...
                      <div key={label} className="flex items-start gap-3 text-sm">
                        {included ? (
                          <div className="w-5 h-5 rounded-full bg-[#F4E8E3] flex items-center justify-center flex-shrink-0 mt-0.5">
                            <Check className="w-3 h-3 text-[#A85740]" />
                          </div>
                        ) : (
                          <div className="w-5 h-5 rounded-full bg-[#F5F0EB] flex items-center justify-center flex-shrink-0 mt-0.5">
                            <X className="w-2.5 h-2.5 text-[#6E6E6E]" />
                          </div>
                        )}
                        <span className={included ? "text-[#1A1A1A]" : "text-[#6E6E6E] line-through decoration-[#E5E5E5]"}>{label}</span>
                      </div>
                    ))}
                  </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <div className={`w-8 h-8 rounded-full ${isOpen ? "bg-[#F4E8E3]" : "bg-[#F5F0EB]"} flex items-center justify-center flex-shrink-0 transition-colors`}>
                          <Plus
                            className={`w-4 h-4 text-[#A85740] transition-transform duration-300 ${isOpen ? "rotate-45" : ""}`}
                          />
                        </div>
                      </button>
                      {isOpen && (
