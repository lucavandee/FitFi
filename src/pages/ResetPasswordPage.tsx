...
const ResetPasswordPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({
        general:
          "Er ging iets mis bij het wijzigen van je wachtwoord. Probeer het opnieuw.",
      });
    } finally {
      setIsLoading(false);
    }
  ...
  const getPasswordStrength = (
    ...
    if (strength <= 3)
      return { strength, label: "Gemiddeld", color: "bg-yellow-500" };
    if (strength <= 4)
      return { strength, label: "Sterk", color: "bg-green-500" };
        ...
        <div className="max-w-md w-full">
          <div className="bg-white rounded-3xl shadow-sm p-8 text-center">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Je wachtwoord is succesvol gewijzigd. Je wordt automatisch
