...
export default function PrivacyPage() {
  return (
    <div className="section">
      <Seo title="Privacy Policy" description="Hoe FitFi met persoonsgegevens omgaat." canonical="https://www.fitfi.ai/privacy" />
      <div className="container">
        <h1 className="text-ink text-3xl md:text-4xl font-extrabold">Privacy Policy</h1>
