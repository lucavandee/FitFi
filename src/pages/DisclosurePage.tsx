    ...
    content: (
      <ul className="space-y-3">
        ...
        <li className="flex items-start gap-3 text-[15px] text-[#4A4A4A] leading-[1.7]">
          ...
          <NavLink to="/contact" className="text-[#B55E45] hover:text-[#9A503B] underline underline-offset-4 transition-colors duration-200">
            Laat het ons weten
          </NavLink>.
        </li>
      </ul>
  ...
  },
  {
    ...
    content: (
      <p className="text-[15px] text-[#4A4A4A] leading-[1.7]">
        ...
        <NavLink to="/veelgestelde-vragen" className="text-[#B55E45] hover:text-[#9A503B] underline underline-offset-4 transition-colors duration-200">
          FAQ
        </NavLink>{' '}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center flex-shrink-0 shadow-sm">
                <ShieldCheck className="w-5 h-5 text-[#B55E45]" aria-hidden="true" />
              </div>
              <div>
        ...
        <section className="bg-[#F5F0EB] py-40 text-center" aria-label="Meer weten">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <Link
                to="/contact"
                className="inline-flex items-center justify-center gap-2 px-10 py-4 rounded-xl bg-[#B55E45] hover:bg-[#9A503B] text-white font-semibold text-[15px] transition-colors duration-200"
              >
                Stel een vraag
