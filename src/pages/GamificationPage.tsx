...
const GamificationPage: React.FC = () => {
      ...
      <div className="min-h-screen bg-gradient-to-br from-stone-50 to-amber-50 py-8 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-sm p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">
              We konden je levels niet laden
            </h2>
            <p className="text-gray-600 mb-6">
              Er ging iets mis bij het laden van je gamification data. Probeer
              het later opnieuw.
            </p>
  ...
  return (
    <>
      <Helmet>
        <title>
          Gamification Dashboard - Levels, Challenges & Leaderboards | FitFi
        </title>
        <meta
          name="description"
          content="Bekijk je level, voltooi challenges en vergelijk je score met andere FitFi gebruikers op het gamification dashboard."
        />
        <meta property="og:title" content="FitFi Gamification Dashboard" />
        <meta
          property="og:description"
          content="Levels, challenges en leaderboards voor de ultieme FitFi ervaring."
        />
          ...
          <div className="mb-8">
            ...
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Verdien punten, voltooi challenges en klim omhoog in de
                leaderboards
              </p>
            </div>
          </div>
