      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-8">
            Vind antwoorden op al je vragen over FitFi. Doorzoek onze kennisbank
            of blader door categorieën.
          </p>
            ...
            <form onSubmit={handleSearch}>
              <div className="relative">
                <input
                  ...
                  placeholder="Zoek in helpcentrum/* placeholder removed */"
                    ...
                    <ul className="space-y-2">
                      <li>
                        <Link
                          ...
                          className="text-gray-600 dark:text-gray-400 hover:text-orange-500 transition-colors flex items-center"
                        >
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      ...
                      <li>
                        <Link
                          to="/help/styling/recommendations"
                          className="text-gray-600 dark:text-gray-400 hover:text-orange-500 transition-colors flex items-center"
                        >
                          <ChevronRight size={16} className="mr-1" />
        ...
        <div className="bg-gradient-to-r from-orange-500 to-orange-600 dark:from-orange-700 dark:to-orange-800 rounded-xl shadow-md overflow-hidden transition-colors mb-16">
          <div className="p-8 text-center">
            ...
            <p className="text-white/90 mb-6 max-w-2xl mx-auto">
              Ons supportteam staat klaar om je te helpen met al je vragen. Neem
