  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Lees onze algemene voorwaarden en gebruiksvoorwaarden voor het gebruik van FitFi's AI-powered styling platform."
        />
        <meta
          property="og:title"
          content="Algemene Voorwaarden - Gebruiksvoorwaarden FitFi"
        />
        <meta
          property="og:description"
          content="Gebruiksvoorwaarden voor FitFi's AI-powered styling platform."
        />
