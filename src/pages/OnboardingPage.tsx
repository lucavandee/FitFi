      ...
      <div className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-light text-gray-900 mb-6 leading-tight">
            Welkom bij FitFi,{" "}
            <span className="font-medium text-[#bfae9f]">{user.name}!</span>
          </h1>

          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8 leading-relaxed">
            Laten we je stijlprofiel opzetten met onze slimme AI-quiz. In
            slechts 2 minuten krijg je gepersonaliseerde outfit aanbevelingen.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                AI analyseert jouw unieke stijl
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Perfect passende aanbevelingen
              </p>
            </div>
          </div>
