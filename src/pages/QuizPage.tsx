...
const QuizPage: React.FC = () => {
      ...
      <div className="min-h-screen bg-[#FAF8F6] flex items-center justify-center">
        <div className="bg-white p-8 rounded-3xl shadow-sm text-center max-w-md">
          ...
          <p className="text-gray-600 mb-6">
            Je moet ingelogd zijn om de quiz te doen.
          </p>
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (success) {
        ...
        toast.error(
          "Er ging iets mis bij het opslaan van je antwoorden. Probeer het opnieuw.",
        );
      }
    } catch (error) {
  ...
  const renderQuestionInput = () => {
    ...
    switch (currentStepData.type) {
      ...
      case "slider":
        const sliderValue =
          typeof value === "number" ? value : currentStepData.min || 0;
        return (
          <div className="space-y-6">
            ...
            <div className="px-4">
              <input
                ...
                value={sliderValue}
                onChange={(e) =>
                  handleAnswerChange(field, parseInt(e.target.value))
                }
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500">
            Je antwoorden worden veilig opgeslagen en alleen gebruikt voor jouw
