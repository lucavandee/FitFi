...
const VALUES: Value[] = [
  {
    ...
    desc: "We vertalen jouw voorkeuren naar outfits die kloppen – van silhouet tot materiaal en kleur.",
  },
  {
    title: "Minimal & warm",
    desc: "Premium, rustig en functioneel. Elke pixel heeft een reden, geen ruis of drukte.",
  },
  {
    title: "Privacy-first",
    desc: "Jouw gegevens zijn van jou. We gebruiken antwoorden alleen om je stijl te personaliseren.",
  },
  {
    title: "Eerlijk & transparant",
    desc: "Soms gebruiken we affiliate links; aanbevelingen blijven altijd stijl- en pasvorm-gedreven.",
  },
  {
    title: "Inclusief & nuchter",
    desc: "We ontwerpen voor echte mensen, echte lichamen en echte situaties – zonder poeha.",
  },
  {
    title: "Continu beter",
    desc: "We leren van feedback en passen FitFi doorlopend aan op wat voor jou werkt.",
  },
];
  ...
  return (
    <article className="ff-card ff-hover-lift p-5 h-full ff-fade-in" aria-labelledby={id}>
      <div className="flex items-start gap-3">
        <div
          aria-hidden="true"
          className="shrink-0 grid place-items-center size-9 rounded-full border border-border"
      ...
      <section aria-labelledby="about-title" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
        ...
        <section aria-labelledby="values-title" className="mt-8 sm:mt-10">
          ...
          <p className="mt-1 text-text/80">
            Alles wat we bouwen toetst hieraan — van UI-details tot aanbevelingen en copy.
          </p>

          <ul className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {VALUES.map((v, i) => (
              <li key={v.title}><ValueCard v={v} i={i} /></li>
            ))}
          </ul>
        </section>
        ...
        <section aria-labelledby="trust-title" className="mt-8 sm:mt-10">
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="ff-card p-4">
              <p className="font-medium">Geen ruis</p>
              <p className="text-sm text-text/80">We filteren trends en focussen op wat werkt voor jouw lichaam, agenda en smaak.</p>
            </div>
            <div className="ff-card p-4">
              <p className="font-medium">Leg uit, niet opleggen</p>
              <p className="text-sm text-text/80">Je ziet waarom een look werkt (kleur, silhouet, materiaal), zodat je zelfverzekerd kiest.</p>
            </div>
            <div className="ff-card p-4">
              <p className="font-medium">Jij houdt de controle</p>
              <p className="text-sm text-text/80">Instellingen, data en alerts staan in jouw hand. Transparant en eenvoudig aan/uit.</p>
            </div>
          </div>
        </section>
