  ...
  const uspCards = [
    {
      ...
      description:
        "Onze geavanceerde AI analyseert jouw unieke stijl en persoonlijkheid voor perfect passende aanbevelingen.",
    ...
    },
    {
      ...
      description:
        "Wij verdienen alleen als jij tevreden bent. Geen verborgen commissies of gesponsorde aanbevelingen.",
    ...
    },
    {
      ...
      description:
        "Focus op kwaliteit boven kwantiteit. Bouw een tijdloze garderobe die jaren meegaat.",
    ...
    },
    {
      ...
      description:
        "Niet tevreden? Krijg je geld terug, geen vragen gesteld. Wij staan achter onze service.",
  ...
  return (
    <div className="min-h-screen bg-[#F6F6F6]">
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Ontdek waarom duizenden mensen kiezen voor FitFi's AI-powered styling advies. Onafhankelijk, duurzaam en met 14-dagen geld-terug garantie."
        />
        <meta
          property="og:title"
          content="Waarom FitFi? - AI-Powered Personal Styling"
        />
        <meta
          property="og:description"
          content="Ontdek waarom duizenden mensen kiezen voor FitFi's AI-powered styling advies."
        />
              ...
              <div className="flex flex-col lg:flex-row items-center">
                <div className="flex-1 text-center lg:text-left mb-12 lg:mb-0 lg:pr-10">
                  ...
                  <p className="text-gray-600 text-lg md:text-xl mt-6 copy-narrow mb-8 leading-relaxed">
                    Wij revolutioneren personal styling met AI — radicaal
                    onafhankelijk, persoonlijk en met oog voor kwaliteit en
                    duurzaamheid.
                  </p>
          ...
          <section className="py-20 bg-white rounded-3xl shadow-sm mb-16">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
              <div className="text-center mb-16">
                ...
                <p className="text-gray-600 text-lg md:text-xl mt-6 copy-narrow mb-8 leading-relaxed">
                  Wij revolutioneren personal styling met AI-technologie,
                  onafhankelijk advies en een focus op{" "}
                  <span className="heading-reset accent-underline">
                    duurzaamheid
                  </span>
                  .
                </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                {uspCards.map((card) => (
                  <div key={card.id} className="text-center group">
                    <div
                      className={`w-16 h-16 ${card.color} rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform`}
                    >
                      {card.icon}
                    </div>
          ...
          <section className="py-20 bg-gradient-to-r from-[#89CFF0]/10 to-blue-50 rounded-3xl shadow-sm mb-16">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl text-center">
              ...
              <p className="text-xl text-gray-700 leading-relaxed max-w-4xl mx-auto mb-8">
                Wij geloven dat iedereen recht heeft op stijladvies dat echt bij
                hen past. Daarom hebben we FitFi ontwikkeld: een AI-powered
                platform dat jouw unieke persoonlijkheid, lichaamsbouw en
                lifestyle analyseert om gepersonaliseerde outfit aanbevelingen
                te doen die je zelfvertrouwen boosten.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6">
                  ...
                  <p className="text-gray-600">
                    Personal styling voor iedereen, niet alleen voor de elite.
                  </p>
                </div>
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6">
                  <h3 className="text-lg font-medium text-[#0D1B2A] mb-3">
                  ...
                  <p className="text-gray-600">
                    Voor alle lichaamstypes, budgets en stijlvoorkeuren.
                  </p>
                </div>
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6">
                  <h3 className="text-lg font-medium text-[#0D1B2A] mb-3">
                  ...
                  <p className="text-gray-600">
                    Focus op tijdloze stukken die jaren meegaan.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="bg-gradient-to-r from-[#89CFF0] to-blue-500 rounded-3xl shadow-sm overflow-hidden">
            <div className="p-8 md:p-12 text-center">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
                Sluit je aan bij duizenden tevreden gebruikers en ontdek wat
                FitFi voor jou kan betekenen.
              </p>
              <Button
                as={Link}
                to="/registreren"
