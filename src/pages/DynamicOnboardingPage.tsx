      ...
      <div className="min-h-screen bg-[#FAF8F6] flex items-center justify-center">
        <div className="bg-white p-8 rounded-3xl shadow-sm text-center max-w-md">
          ...
          <p className="text-gray-600 mb-6">
            Je moet ingelogd zijn voor dynamic onboarding.
          </p>
      ...
      case "occasion":
        return (
          <div className="text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
              {["Werk", "Casual", "Formeel", "Uitgaan", "Sport", "Reizen"].map(
                (occasion) => (
                  <button
                    key={occasion}
                    onClick={() => {
          ...
          <div className="text-center">
            ...
            <div className="space-y-4 max-w-md mx-auto">
              {[
                ...
                <label
                  key={pref.key}
                  className="flex items-center space-x-3 p-4 border border-gray-200 rounded-2xl hover:border-[#89CFF0] cursor-pointer"
                >
                  <input
                    type="checkbox"
                    checked={
                      data.preferences?.[
                        pref.key as keyof typeof data.preferences
                      ] || false
                    }
                    onChange={(e) =>
                      updateAnswers({
        ...
        return (
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Je dynamic onboarding is voltooid. We gaan nu je enhanced
      ...
      <div className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          <div className="flex justify-between text-sm text-gray-500 mb-2">
            <span>
              Stap {getStepNumber()} van {totalSteps}
            </span>
