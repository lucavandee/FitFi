...
const inputClass =
  "w-full rounded-xl border border-[var(--color-border)] bg-[var(--color-bg)] px-4 py-3 text-sm text-[var(--color-text)] placeholder:text-[var(--color-muted)] focus:border-[var(--ff-color-primary-500)] focus:outline-none focus:ring-2 focus:ring-[var(--ff-color-primary-400)]/25 transition-all";
    ...
    <div>
      ...
      {touched && error && (
        <p
          id={`err-${id}`}
          role="alert"
          className="mt-1.5 text-xs text-[var(--ff-color-danger-600)] flex items-center gap-1"
        >
...
export default function ContactPage() {
  ...
  return (
    <main id="main" className="bg-[var(--color-bg)] text-[var(--color-text)]">
      ...
      {/* ── HERO (centered, gradient, compact) ── */}
      <section className="relative overflow-hidden bg-gradient-to-b from-[var(--ff-color-primary-50)] to-[var(--color-bg)] pt-14 pb-16 md:pt-20 md:pb-20">
        <div className="ff-container">
          <div className="max-w-2xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/80 backdrop-blur-sm border border-[var(--ff-color-primary-200)] rounded-full text-xs font-semibold text-[var(--ff-color-primary-700)] mb-6 shadow-sm">
      ...
      <section className="ff-container pb-24">
        <div className="max-w-5xl mx-auto -mt-6 grid grid-cols-1 lg:grid-cols-[1fr_288px] gap-8 lg:gap-10 items-start">
          ...
          <div>
            ...
            <div
              className="rounded-2xl bg-[var(--color-surface)] border border-[var(--color-border)] p-8"
