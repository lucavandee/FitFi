      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            <BarChart3 className="inline-block w-10 h-10 mr-3 text-[#B55E45]" />
            Swipe Analytics
          </h1>
        ...
        {globalStats && (
          <div className="bg-white rounded-2xl border border-[#E5E5E5] p-8 shadow-lg mb-12">
            <h2 className="text-2xl font-bold mb-6 flex items-center gap-3">
              <ImageIcon className="w-6 h-6 text-[#B55E45]" />
              Photo Distribution
            </h2>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-2xl font-bold text-[#B55E45]">
                        #{idx + 1}
                      </span>
        ...
        <div className="mt-12 bg-gradient-to-br from-[#FAF5F2] to-[#FAF5F2] rounded-2xl p-8 border border-[#F4E8E3]">
          ...
          <ul className="space-y-2 text-gray-700">
            <li className="flex items-start gap-2">
              <span className="text-[#B55E45] font-bold">•</span>
