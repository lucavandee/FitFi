...
const EnhancedResultsPage: React.FC = () => {
  ...
  if (userLoading || quizLoading) {
    return <LoadingFallback fullScreen message="Enhanced resultaten laden..." />;
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#FAF8F6] via-white to-[#F5F3F0] flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-8">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2">
            <div className="bg-[#89CFF0] h-2 rounded-full animate-pulse" style={{ width: '85%' }}></div>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Gebaseerd op jouw onboarding en quiz antwoorden hebben we een uitgebreid stijlprofiel voor je samengesteld
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="lg:col-span-2 bg-white rounded-3xl shadow-sm p-8">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-medium text-gray-900">Enhanced Stijlprofiel</h2>
              <div className="flex items-center space-x-2">
                <Star className="w-5 h-5 text-yellow-400 fill-current" />
                <span className="text-lg font-medium text-gray-900">92% Enhanced Match</span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h4 className="font-medium text-gray-900">Enhanced voorkeuren analyse:</h4>
              <div className="space-y-3">
                <div>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div className="bg-[#89CFF0] h-2 rounded-full" style={{ width: '92%' }}></div>
                  </div>
                </div>
                <div>
                  <div className="flex justify-between text-sm mb-1">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-3xl shadow-sm p-6">
              <h3 className="font-medium text-gray-900 mb-4">Enhanced Statistieken</h3>
              <div className="space-y-4">
            ...
            {/* Enhanced Actions */}
            <div className="bg-white rounded-3xl shadow-sm p-6">
              <h3 className="font-medium text-gray-900 mb-4">Enhanced Acties</h3>
              <div className="space-y-3">
                <Button
                  variant="primary"
                  fullWidth
        ...
        <div className="bg-white rounded-3xl shadow-sm p-8 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Met je enhanced stijlprofiel kunnen we nog betere gepersonaliseerde outfit aanbevelingen voor je maken.
          </p>
...
function getEnhancedStyleProfileTitle(quizAnswers: any, onboardingData: any): string {
...
function getEnhancedStyleDescription(quizAnswers: any, onboardingData: any): string {
  ...
  description += 'voor een volledig gepersonaliseerde stijlervaring die perfect bij jouw persoonlijkheid en lifestyle past.';
...
function getEnhancedStyleTags(quizAnswers: any, onboardingData: any): string[] {
  ...
  if (onboardingData?.archetypes) {
    tags.push(...onboardingData.archetypes.map((arch: string) => 
      arch.charAt(0).toUpperCase() + arch.slice(1).replace('_', ' ')
    ));
  }
  
  if (onboardingData?.season) {
    tags.push(onboardingData.season.charAt(0).toUpperCase() + onboardingData.season.slice(1));
  }
