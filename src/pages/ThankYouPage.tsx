      ...
      <div className="max-w-md w-full mx-auto">
        <div className="bg-white border border-[#E5E5E5] rounded-2xl p-6 md:p-8 shadow-sm text-center">
          <div className="w-16 h-16 bg-[#F4E8E3] rounded-2xl flex items-center justify-center mx-auto mb-6">
            <CheckCircle className="w-8 h-8 text-[#A85740]" />
          </div>
          ...
          <div className="space-y-3 mb-8">
            <div className="bg-[#F5F0EB] rounded-xl p-4 flex items-center gap-3 text-left">
              <Clock className="w-5 h-5 text-[#A85740] flex-shrink-0" />
              <div>
            ...
            <div className="bg-[#F5F0EB] rounded-xl p-4 flex items-center gap-3 text-left">
              <Mail className="w-5 h-5 text-[#A85740] flex-shrink-0" />
              <div>
          ...
          <div className="space-y-3">
            <Link
              to="/"
              className="flex items-center justify-center gap-2 w-full bg-[#A85740] hover:bg-[#9A503B] text-white font-semibold text-base py-3 px-6 rounded-xl transition-colors duration-200"
            >
              Terug naar home
            ...
            <Link
              to="/blog"
              className="flex items-center justify-center w-full bg-white border border-[#E5E5E5] hover:border-[#A85740] text-[#1A1A1A] font-medium text-base py-3 px-6 rounded-xl transition-colors duration-200"
            >
              Lees onze blog
            </Link>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-[#E5E5E5]">
            ...
            <a
              ...
              className="text-[#A85740] hover:text-[#9A503B] text-sm font-medium transition-colors duration-200"
            >
              info@fitfi.ai
            </a>
          </div>
