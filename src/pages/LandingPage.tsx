...
export default function LandingPage() {
  return (
    <main className="bg-[var(--color-bg)] text-[var(--color-text)]">
      ...
      {/* HERO — alleen spacing/ritme verbeterd, niets verwijderd */}
      <section className="relative">
        <div
          className={[
            "ff-container",
            // Royale verticale ademruimte — vooral op mobiel meer lucht
        ...
        >
          ...
          {/* Subtitel — korter regelblok en meer afstand voor rust */}
          ...
          {/* CTA-groep — verticale stack met consistente gap op mobiel */}
          <div className="mt-6 sm:mt-8 flex flex-col xs:flex-row flex-wrap gap-3">
            <Button as={NavLink} to="/registreren" variant="primary" size="lg">
              Start gratis
            </Button>
          ...
          {/* Badge-groep — eigen blok met grotere top-margin op mobiel */}
          <div className="mt-6 sm:mt-7 flex flex-wrap items-center gap-3">
            <span className="inline-flex items-center rounded-[var(--radius-2xl)] border border-[var(--color-border)] bg-[var(--color-surface)] px-4 py-2 text-sm">
              100% gratis
            </span>
            <span className="inline-flex items-center rounded-[var(--radius-2xl)] border border-[var(--color-border)] bg-[var(--color-surface)] px-4 py-2 text-sm">
              Klaar in 2 min
          ...
          {/* Trust-row — discrete, losstaande rij met ademruimte */}
