        ...
        >
          ...
          <div className="relative z-10 w-full max-w-[1320px] mx-auto px-6 md:px-10 pb-16 md:pb-24 pt-20 min-h-screen flex items-end">
            <div className="max-w-[560px]">
              ...
              <div className="flex items-center gap-[10px] mb-6">
                <div className="w-8 h-px bg-[#B55E45]" aria-hidden="true" />
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
                <button
                  ...
                  className="group inline-flex items-center gap-3 bg-[#B55E45] hover:bg-[#9A503B] text-white font-semibold text-[15px] py-[18px] px-10 rounded-full transition-all duration-200 hover:-translate-y-0.5"
                  style={{
          ...
          >
            <div className="flex gap-3">
              <div className="w-10 h-10 rounded-full bg-[#B55E45]" />
        ...
        <div className="py-7 border-b border-[#E5E5E5] overflow-hidden bg-[#FAFAF8]">
          ...
          >
            ...
            {[...marqueeItems, ...marqueeItems].map((item, i) => (
              ...
              >
                <div className="w-1 h-1 rounded-full bg-[#B55E45] flex-shrink-0" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <Reveal key={step.num} delay={i * 0.12}>
                  <div className="bg-white border border-[#E5E5E5] rounded-2xl p-8 md:p-12 relative overflow-hidden group transition-all duration-200 hover:border-[#B55E45] hover:-translate-y-1 hover:shadow-[0_20px_60px_rgba(0,0,0,0.06)] h-full flex flex-col">
                    {/* Big number */}
                    <span
                    ...
                    <div className="w-12 h-12 rounded-2xl bg-[#F5F0EB] flex items-center justify-center mb-7">
                      <step.icon className="w-[22px] h-[22px] text-[#B55E45]" />
                    </div>
                    ...
                    {/* Tag */}
                    <div className="flex items-center gap-2 mt-6 text-xs font-semibold text-[#B55E45]">
        ...
        <section className="bg-[#F5F0EB]">
          <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[640px]">
            ...
            <Reveal
              ...
              delay={0.12}
            >
              <span className="text-xs font-semibold tracking-[2px] uppercase text-[#B55E45] mb-4">
                Kleuradvies
              </span>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  >
                    <div className="w-2 h-2 rounded-full bg-[#B55E45] mt-2 flex-shrink-0" />
                    {item}
                  </li>
                ))}
              </ul>
                ...
                <Reveal key={card.title} delay={i * 0.12}>
                  <div className="bg-[#F5F0EB] rounded-2xl p-8 md:p-10 h-full">
                    <div className="w-12 h-12 rounded-2xl bg-white flex items-center justify-center mb-6">
                      <card.icon className="w-[22px] h-[22px] text-[#B55E45]" />
                    </div>
                  ...
                  <article className="bg-white rounded-2xl p-8 md:p-10 pt-8 md:pt-10 h-full flex flex-col">
                    ...
                    <div className="flex items-center gap-3.5 pt-5 border-t border-[#E5E5E5]">
                      <div className="w-11 h-11 rounded-full bg-[#F4E8E3] flex items-center justify-center flex-shrink-0">
                        <span className="text-sm font-bold text-[#B55E45]">
                          {review.initial}
                        </span>
                      </div>
                      <div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <Reveal>
              <div className="text-center">
                ...
                <button
                  onClick={handleStartClick}
                  className="group inline-flex items-center gap-3 bg-[#B55E45] hover:bg-[#9A503B] text-white font-semibold text-base md:text-[17px] py-5 px-12 rounded-full transition-all duration-200 hover:-translate-y-0.5"
                  style={{
                    boxShadow: "0 12px 40px rgba(194,101,74,0.3)",
                  }}
                >
