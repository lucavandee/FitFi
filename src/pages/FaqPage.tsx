...
const gettingStarted: FaqItem[] = [
  {
    ...
    a: "Binnen 2 minuten. Beantwoord 6 korte vragen en je ontvangt direct je persoonlijke stijlprofiel met outfits.",
  },
  {
    q: "Heb ik een account of creditcard nodig?",
    a: "Nee. Je kunt gratis starten zonder account of creditcard. Upgraden kan later als je wilt.",
  },
  {
    q: "Kan ik ook zonder foto advies krijgen?",
    a: "Ja. Een foto is optioneel. Ons model werkt privacy-first en kan op basis van je antwoorden een helder profiel maken.",
  },
];

const billing: FaqItem[] = [
  {
    q: "Wat is het verschil tussen Pro en Premium?",
    a: "Pro geeft je een volledig rapport met wekelijkse updates en 10+ outfits met shoplinks. Premium voegt seizoens-capsules, prioriteitenlijsten en early access toe.",
  },
  {
    q: "Kan ik maandelijks betalen of jaarlijks met korting?",
    a: "Beide. Jaarlijks krijg je 20% voordeel. Je kunt op elk moment opzeggen; je plan stopt aan het einde van je periode.",
  },
  {
    q: "Kan ik mijn plan later wijzigen?",
    a: "Ja. Upgraden of downgraden kan altijd. Wijzigingen worden per volgende periode toegepast.",
  },
];
...
const privacy: FaqItem[] = [
  {
    ...
    a: "Zo min mogelijk. We hanteren een privacy-first aanpak: minimale data, transparant verwerkt. Jij houdt regie.",
  },
  {
    q: "Worden mijn foto's opgeslagen?",
    a: "Alleen als je daar expliciet toestemming voor geeft om je advies te verbeteren. Standaard bewaren we geen foto's.",
  },
  {
    q: "Kan ik mijn gegevens laten verwijderen?",
    a: "Ja. Stuur ons een bericht via de contactpagina en we verwijderen je gegevens conform AVG.",
  },
];
