 ...
 */
export function isProductSuitableForWeather(
  product: Product,
  weather: Weather,
): boolean {
  ...
  return product.season.some((season) =>
    suitableSeasons.includes(season as Season),
  );
}
