...
export function titleFrom(archetype: string, keyItem: string | undefined, season: Season | undefined) {
...
export function descriptionFrom(params: {
  ...
  const second = params.secondary ? ` met een ${params.secondary.replace('_', ' ')} twist` : '';
